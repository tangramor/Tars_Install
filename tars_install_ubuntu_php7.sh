...
install_software(){
	apt install -y build-essential cmake wget mariadb-server libmariadbclient-dev libmariadbclient18 unzip iproute2 flex bison expect libncurses5-dev libprotobuf-dev libprotoc-dev zlib1g-dev ca-certificates vim rsync locales apache2 composer php7.2 php7.2-cli php7.2-dev php7.2-gd php7.2-curl php7.2-mysql php7.2-zip php7.2-fileinfo php7.2-mbstring php-redis redis-server
